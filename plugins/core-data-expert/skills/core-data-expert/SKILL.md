...
description: 'Expert Core Data guidance (iOS/macOS): stack setup, fetching, threading, Swift Concurrency, batch ops, migration, performance, and CloudKit sync. Use when building, debugging, migrating, or optimizing a Core Data stack.'
---
# Core Data Expert
...
- **Auditing an existing project's Core Data setup** → `references/project-audit.md`
