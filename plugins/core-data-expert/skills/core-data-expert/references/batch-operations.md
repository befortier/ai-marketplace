...
- [Overview](#overview)
- [NSBatchInsertRequest (iOS 14+)](#nsbatchinsertrequest-ios-14)
- [NSBatchDeleteRequest](#nsbatchdeleterequest)
- [NSBatchUpdateRequest](#nsbatchupdaterequest)
- [Persistent History Tracking Integration](#persistent-history-tracking-integration)
- [Performance Comparison](#performance-comparison)
- [When to Use Batch Operations](#when-to-use-batch-operations)
- [Complete Example: Import with Batch Insert](#complete-example-import-with-batch-insert)
- [Complete Example: Cleanup with Batch Delete](#complete-example-cleanup-with-batch-delete)
